...
const TRANSLATIONS = {
    en: {
        ...
        // Progress
        'progress.heading': 'ðY"S Your Learning Progress',
        ...
        // Sections
        'section.dailyChallenge': 'ðY"¥ Daily Challenge',
        'section.studyTip': 'ðYOY Study Tip',
        ...
        'interview.heading': 'ðY", Interview Examples',
        ...
        'ds.heading': 'ðY> ï¸ Data Structure Code Playground',
        ...
        // Support
        'support.heading': 'â¤ï¸ Do you enjoy this website?',
        ...
        'books.heading': 'ðY"s Books Library',
        ...
        'footer.quick.flashcards': 'ðYZ¯ Open Flashcards',
        'footer.quick.quizzes': 'ðY§  Start a Quiz',
        'footer.quick.glossary': 'ðY"s Browse Glossary',
        'footer.tools.title': 'ðY"- Study Tools',
        'footer.tools.flashcards': 'ðYZ¯ Practice Flashcards',
        'footer.tools.glossary': 'ðY"s CS Glossary',
        'footer.tools.quizzes': 'ðY§  Interactive Quizzes',
        ...
        'footer.features.title': 'ðYs? Core Features',
        'footer.features.one': 'Individual Comment Controls',
        'footer.features.two': 'ðY" Pseudocode Conversion',
        'footer.features.three': 'ðY> ï¸ Multi-Language Support',
        'footer.features.four': 'ðY"± Mobile-Optimized Design',
        'footer.features.five': 'ðYOT Dark Mode Support',
        ...
        'footer.support.coffee': 'â~. Coffee',
        ...
        'footer.bottom.copyright': 'CS Course Atlas Â© 2024 | Open Source â¤ï¸',
        // Settings modal
        'settings.title': 'âsTï¸ Settings',
        ...
        'settings.save': 'âo" Save & Close',
        // Module card labels/tooltips
        'module.starterBanner': 'â­ Starter Module: recommended first step for most learners',
        'module.topicsCovered': 'Topics Covered:',
        'module.codeExample': 'Code Example',
        'module.discreteTheory': 'ðY"~ Discrete Mathematics Theory',
        'module.theoryMode': 'Theory Mode',
        'module.learningResources': 'ðY"s Learning Resources:',
        'module.definitionsHeading': 'ðY"~ Need-to-Know Definitions',
        ...
        'module.collapse': 'ðY"" Collapse',
        'module.expand': 'ðY"- Expand',
    ...
    es: {
        ...
        // Progress
        'progress.heading': 'ðY"S Tu Progreso de Aprendizaje',
        'progress.kicker': 'Recorrido actual',
        // Topic focus
        'topic.focus.heading': 'Enfoque de Temas',
        'topic.focus.subtitle': 'Elige tu ruta principal. Esto controla quÃ© familia de mÃ³dulos se muestra.',
        ...
        // Sections
        'section.dailyChallenge': 'ðY"¥ DesafÃ­o del DÃ­a',
        'section.studyTip': 'ðYOY Consejo de Estudio',
        ...
        'interview.heading': 'ðY", Ejemplos de Entrevista',
        ...
        'ds.heading': 'ðY> ï¸ Playground de CÃ³digo de Estructuras de Datos',
        ...
        // Support
        'support.heading': 'â¤ï¸ Â¿Disfrutas este sitio web?',
        ...
        'helper.ariaLabel': 'Abrir guÃ­a rÃ¡pida del sitio web',
        ...
        'books.heading': 'ðY"s Biblioteca de Libros',
        ...
        'footer.quick.flashcards': 'ðYZ¯ Abrir Tarjetas',
        'footer.quick.quizzes': 'ðY§  Iniciar Quiz',
        'footer.quick.glossary': 'ðY"s Ver Glosario',
        'footer.tools.title': 'ðY"- Herramientas de Estudio',
        'footer.tools.flashcards': 'ðYZ¯ Practicar Tarjetas',
        'footer.tools.glossary': 'ðY"s Glosario de CS',
        'footer.tools.quizzes': 'ðY§  Cuestionarios Interactivos',
        ...
        'footer.features.title': 'ðYs? Funciones Clave',
        'footer.features.one': 'Controles de comentarios individuales',
        'footer.features.two': 'ðY" ConversiÃ³n a PseudocÃ³digo',
        'footer.features.three': 'ðY> ï¸ Soporte Multi-Lenguaje',
        'footer.features.four': 'ðY"± DiseÃ±o Optimizado para MÃ³vil',
        'footer.features.five': 'ðYOT Soporte de Modo Oscuro',
        ...
        'footer.bottom.copyright': 'CS Course Atlas Â© 2024 | CÃ³digo Abierto â¤ï¸',
        // Settings modal
        'settings.title': 'âsTï¸ Ajustes',
        ...
        'settings.save': 'âo" Guardar y Cerrar',
        // Module card labels/tooltips
        'module.starterBanner': 'â­ MÃ³dulo inicial: primer paso recomendado para la mayorÃ­a',
        'module.topicsCovered': 'Temas cubiertos:',
        'module.codeExample': 'Ejemplo de codigo',
        'module.discreteTheory': 'ðY"~ TeorÃ­a de MatemÃ¡ticas Discretas',
        'module.theoryMode': 'Modo TeorÃ­a',
        'module.learningResources': 'ðY"s Recursos de aprendizaje:',
        'module.definitionsHeading': 'ðY"~ Definiciones Clave',
        ...
        'module.collapse': 'ðY"" Contraer',
        'module.expand': 'ðY"- Expandir',
...
const baseFlashcards = [
    ...
    },
    {
        ...
        answer: "LinkedList stores elements as nodes with next pointers.\n\nUse when:\nâ?¢ Frequent insert/delete\nâ?¢ Unknown or changing size\nâ?¢ No random access needed"
    },
    {
        id: 5,
        question: "How does Floydâ?Ts Cycle Detection Algorithm work?",
    ...
    {
        id: 13,
        question: "Whatâ?Ts the difference between DFS and BFS?",
    ...
    {
        id: 19,
        question: "Whatâ?Ts the space and time of merge sort?",
        answer: "Time: O(n log n)\nSpace: O(n)\n\nItâ?Ts stable and works well on linked lists"
    },
    {
        id: 20,
    ...
    {
        id: 24,
        question: "Whatâ?Ts the difference between recursion and iteration?",
    ...
    {
        id: 27,
        question: "Whatâ?Ts a priority queue?",
    ...
    {
        id: 32,
        question: "Whatâ?Ts a balanced binary tree?",
        answer: "Tree where left and right subtrees of every node differ in height by at most 1"
    },
    {
        id: 33,
        question: "Whatâ?Ts the difference between call stack and heap?",
    ...
    {
        id: 35,
        question: "Whatâ?Ts the difference between BFS and Dijkstra?",
    ...
    {
        id: 38,
        question: "Whatâ?Ts the time complexity of hashmap operations?",
    ...
    },
    {
        ...
        answer: "Linear ordering of nodes in a DAG so u comes before v for all edges u â?' v"
    },
    {
        id: 44,
    ...
    {
        id: 47,
        question: "Whatâ?Ts the difference between min heap and max heap?",
    ...
    {
        id: 49,
        question: "Whatâ?Ts the difference between a shallow copy and deep copy?",
...
const glossaryTerms = [
    ...
    {
        term: "Bubble Sort",
        definition: "Simple sorting algorithm that repeatedly swaps adjacent elements if theyâ?Tre in the wrong order.",
        category: "Algorithms"
    },
    {
        term: "Selection Sort",
    ...
    {
        term: "Floydâ?Ts Cycle Detection",
    ...
    },
    {
        ...
        definition: "Linear ordering of graph vertices such that for every edge u â?' v, u appears before v.",
        category: "Algorithms"
    },
    {
            ...
            questions: [
                {
                    ...
                    correct: 0,
                    explanation: "Random access arrays compute the memory address via base + index Ã- element_size, so lookup cost is constant."
                },
                {
                    id: 2,
            ...
            questions: [
                {
                    ...
                    correct: 1,
                    explanation: "Load factor Î± = n / m drives when to resize; keeping Î± bounded retains O(1) average operations."
                },
                {
                    id: 2,
            ...
            questions: [
                {
                    ...
                    options: ["It sorts automatically", "Parent/child indices follow simple math (iâ?'2i+1/2i+2)", "It needs pointers", "Heapify needs recursion"],
                    correct: 1,
    ...
    'propositional-logic-proofs': {
        parts: [{
            questions: [
                ...
                {
                    id: 2,
                    question: "Implication p â?' q is false only when:",
    ...
    'sets-relations-functions': {
        parts: [{
            questions: [
                {
                    id: 1,
                    question: "For sets A and B, A â^© B means:",
                ...
                },
                {
                    ...
                    options: ["A subset of A Ã- A", "A function from A to A only", "A prime number list", "Always symmetric"],
                    correct: 0,
                    explanation: "A relation on A is any subset of the Cartesian product A Ã- A."
                },
                {
                    id: 3,
                    question: "A function f: A â?' B is injective when:",
    ...
    'combinatorics-discrete-probability': {
        parts: [{
            questions: [
                ...
                {
                    id: 3,
                    question: "For independent events A and B, P(A â^© B) equals:",
                    options: ["P(A) + P(B)", "P(A) / P(B)", "P(A) Ã- P(B)", "1 - P(A)"],
                    correct: 2,
    ...
    'union-find': {
        parts: [{
            questions: [
                ...
                {
                    id: 3,
                    question: "Kruskalâ?Ts MST algorithm uses union-find to:",
...
public class SetsRelationsFunctions {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("A â^© B = " + intersection);
        System.out.println("A â^ª B = " + union);
...
int main() {
    ...
    cout << "A â^© B size = " << intersection.size() << "\\n";
    cout << "A â^ª B size = " << uni.size() << "\\n";
...
console.log("A â^© B =", intersection);
console.log("A â^ª B =", [...union]);
...
public class ExceptionExample {
...

    {
        ...
        description: '`CollectionsExample` builds an `ArrayList`, `HashMap`, and `HashSet` inside `main`, highlighting adds, puts, and duplicate handling so each collectionâ?Ts behavior is tangible.',
        difficulty: 'intermediate',
...
class ShapeFactory {
...

    {
        ...
        description: 'The stream pipeline filters even numbers, maps them to squares, collects a list, then chains mapToInt/filter/average, so each stageâ?Ts role is spelled out in order.',
        difficulty: 'advanced',
...
public class BinarySearchSet {
    ...
    public static void main(String[] args) {
        ...
        },
        {
            ...
            title: { en: 'First & Last Occurrence', es: 'Primera y Ãsltima Ocurrencia' },
...
function normalizeModuleCodeExampleSets(module) {
    ...
    module.codeExampleSets = sourceSets.map((exampleSet, index) => {
        ...
        const javaSource = typeof sourceCodeExamples.java === 'string' && sourceCodeExamples.java.trim()
            ...
            : buildFallbackJavaSnippet({ ...module, title: `${module.title} â?¢ ${setTitleText}` });
...
function renderNotesLibrary() {
    ...
    listEl.innerHTML = items.map(item => `
        <div class="notes-card">
            ...
            <div class="text-xs text-slate-500">${translateLiteral('Category:', appState.language)} ${escapeHtml(item.categoryLabel || item.category)} â?¢ ${item.pages} ${translateLiteral('pages', appState.language)}</div>
...
function openNotesDownloadModal(noteId) {
    ...
    if (metaEl) metaEl.textContent = `${note.categoryLabel || note.category} â?¢ ${note.pages} ${translateLiteral('pages', appState.language)} â?¢ ${note.level}`;
    if (donateLink) {
...
function initPlayground() {
    ...
    const setOutput = (text, options = {}) => {
        ...
        if (outputMeta) {
            const suffix = languageLabel ? ` â?¢ ${languageLabel}` : '';
...
function renderCytoscapeGraphVisual(container) {
    ...
    if (!window.cytoscape || typeof window.cytoscape !== 'function') {
        ...
        const edges = dsState.graph.edges.map((edge) => `${edge.from} â?' ${edge.to}`).join(', ');
...
function buildDSPointerVisual() {
    ...
    if (dsActive === 'stack') {
        return `
            ...
            <div class="ds-pointer-row"><span>${translateLiteral('Top value', appState.language)}</span><strong>${escapeHtml(String(dsState.stack[dsState.stack.length - 1] ?? 'â^.'))}</strong></div>
        `;
    }
    if (dsActive === 'queue') {
        return `
            <div class="ds-pointer-row"><span>${translateLiteral('Front', appState.language)}</span><strong>${escapeHtml(String(dsState.queue[0] ?? 'â^.'))}</strong></div>
            <div class="ds-pointer-row"><span>${translateLiteral('Rear', appState.language)}</span><strong>${escapeHtml(String(dsState.queue[dsState.queue.length - 1] ?? 'â^.'))}</strong></div>
        `;
    }
    if (dsActive === 'heap') {
...
function updateDSComplexity() {
    ...
    summary.textContent = `n=${n} â?¢ ${operation}`;
...
function getDiscreteTheoryContent(module) {
    const topics = (module?.topics || []).map((topic) => `â?¢ ${topic}`);
...
function updateProgress() {
    ...
    const progressStr = completed === 0
        ...
        : (appState.language === 'es'
            ? `${completed} de ${totalModules} mÃ³dulos completados`
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 px-3 py-2 border-b border-slate-200 bg-slate-100">
                        ...
                        <div class="flex flex-wrap gap-1 w-full sm:w-auto">
                            ...
                            <button onclick="toggleModuleComments('${module.id}')" class="text-xs px-2 py-1 rounded transition-all duration-200 font-medium shadow-sm hover:shadow-md flex-shrink-0 ${shouldShowComments(module.id) ? 'bg-green-500 hover:bg-green-600 text-white' : 'bg-gray-500 hover:bg-gray-600 text-white'}" title="${shouldShowComments(module.id) ? t('module.tooltipHideComments') : t('module.tooltipShowComments')}">
                                ðY'¬ ${shouldShowComments(module.id) ? t('module.commentsOn') : t('module.commentsOff')}
                            </button>
            ...
            return `
                ...
                <div class="space-y-2">
                    ...
                    <button onclick="toggleCompletion('${module.id}')" class="w-full py-2 sm:py-2.5 rounded-lg font-semibold transition-all duration-200 shadow-lg hover:shadow-xl text-xs sm:text-sm ${isCompleted ? 'bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white hover:-translate-y-0.5' : 'bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white hover:-translate-y-0.5'}">
                        ${isCompleted ? translateLiteral('âo. Completed!', appState.language) : translateLiteral('ðY" Mark as Complete', appState.language)}
                    </button>
                </div>
            </div>
        `;
...
function renderFlashcard() {
    ...
    if (sessionMeta) {
        ...
        sessionMeta.textContent = `${totalCards} card session â?¢ ${deckSize} cards in deck${repeats ? ` (deck repeats to reach ${desiredLength})` : ''}`;
    }
...
function renderQuiz() {
    ...
    title.textContent = translateLiteral(`ðY§  Quiz: ${localizedModule?.title || 'Quiz'}`, appState.language);
            ...
            <div class="mb-6">
                <div class="flex justify-between items-center mb-4">
                    <span class="text-sm quiz-progress-label">
                        ${translateLiteral(`Question ${appState.currentQuiz.currentQuestion + 1} of ${totalCount} â?¢ ${answeredCount}/${totalCount} answered`, appState.language)}
                    </span>
            ...
            <div class="text-center">
                    ...
                    ${appState.currentQuiz.questions.map((question, index) => `
                        <div class="text-left p-4 rounded-xl border ${appState.currentQuiz.answers[index] === question.correct ? 'border-green-500 bg-green-50' : 'border-red-500 bg-red-50'}">
                            <div class="flex items-start gap-3">
                                <span class="text-xl">
                                    ${appState.currentQuiz.answers[index] === question.correct ? 'âo.' : 'âO'}
                                </span>
                                <div class="flex-1">
                ...
                <div class="flex gap-4 justify-center">
                    <button onclick="restartQuiz()" class="bg-indigo-500 hover:bg-indigo-600 text-white px-6 py-3 rounded-xl font-medium transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5">
                        ${translateLiteral('ðY"" Retake Quiz', appState.language)}
                    </button>
...
function getBreakReminder() {
    if (!studyTimer.isActive || !studyTimer.startTime) {
        return translateLiteral('â± Break reminder in 25 min', appState.language);
    }
    const minutesElapsed = Math.floor((Date.now() - studyTimer.startTime) / 60000);
    if (minutesElapsed >= 25) {
        return translateLiteral('ðYO¿ Stretch & hydrate now!', appState.language);
    }
    return translateLiteral(`â± Break in ${25 - minutesElapsed} min`, appState.language);
}
...
function renderInsights() {
    ...
    if (learningPathNext) {
        if (learningPath.next) {
            ...
            learningPathNext.innerHTML = `
                ...
                <p class="text-xs text-slate-500 mb-1">${translateLiteral(learningPath.next.difficulty, appState.language)} â?¢ ${topics}</p>
    ...
    if (momentumTipEl) {
        ...
        if (modulesRemaining === 0) {
            ...
            tip = translateLiteral('ðY"¥ Your streak is on fire! Consider revisiting advanced challenge sets.', appState.language);
...
console.log('CS Course Atlas - All systems loaded successfully! ðYs?');
...
function renderInteractiveQuizQuestion() {
    ...
    const feedback = selected === null
        ...
        : selected === question.correct
            ? `<p class="text-sm text-emerald-600 font-semibold mt-2">âo. ${translateLiteral('Correct!', appState.language)} ${question.explanation || ''}</p>`
            : `<p class="text-sm text-rose-600 font-semibold mt-2">âO ${translateLiteral('Try again.', appState.language)} ${question.explanation || ''}</p>`;
    ...
    if (progress) {
        ...
        progress.textContent = translateLiteral(`${answered} answered â?¢ ${total} total`, appState.language);
    }
}
