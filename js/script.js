...
const TRANSLATIONS = {
    en: {
        ...
        'topic.comingSoon.os.title': 'Operating Systems',
        'topic.comingSoon.os.subtitle': 'Processes, scheduling, memory management, and file systems from first principles',
        'topic.comingSoon.networks.title': 'Computer Networks',
        'topic.comingSoon.networks.subtitle': 'TCP/IP, routing, transport reliability, and practical network debugging workflows',
        'topic.comingSoon.algorithmsPlus.title': 'Advanced Algorithms',
        'topic.comingSoon.algorithmsPlus.subtitle': 'Dynamic programming, advanced graph methods, string algorithms, and complexity strategy',
        'topic.comingSoon.pl.title': 'Programming Languages',
        'topic.comingSoon.pl.subtitle': 'Language paradigms, type systems, interpreters, compilers, and language design foundations',
        'topic.comingSoon.se.title': 'Software Engineering',
        'topic.comingSoon.se.subtitle': 'Architecture, testing, CI/CD, team workflows, and long-term maintainability practices',
        'topic.comingSoon.arch.title': 'Computer Architecture',
        'topic.comingSoon.arch.subtitle': 'Instruction sets, CPU pipelines, caches, and performance reasoning from hardware to software',
        'topic.comingSoon.cyber.title': 'Cybersecurity',
        'topic.comingSoon.cyber.subtitle': 'Secure coding, authentication, web attack defense, and practical security fundamentals',
        'roadmap.kicker': 'Public Roadmap',
        'roadmap.heading': 'Live Now, In Progress, Planned Next',
        'roadmap.subtitle': 'Track what is already usable today and what is intentionally being built next.',
        'roadmap.live.title': 'Live now',
        'roadmap.live.one': 'DSA, Java, Git, Assembly, and Discrete Math learning tracks',
        'roadmap.live.two': 'Modules with code examples, quizzes, flashcards, glossary, and playground tools',
        'roadmap.live.three': 'Beginner-first onboarding paths and quick guide flow',
        'roadmap.live.four': 'Account login, profile controls, and synced progress foundation',
        'roadmap.progress.title': 'In progress',
        'roadmap.progress.one': 'Cross-device polish and responsive formatting refinements',
        'roadmap.progress.two': 'Deeper module expansions and code-quality consistency pass',
        'roadmap.progress.three': 'Personalized insights tuning and account-only persistence improvements',
        'roadmap.progress.four': 'Public launch hardening for SQL-backed auth and security controls',
        'roadmap.planned.title': 'Planned next',
        'roadmap.planned.one': 'Theory of Computation, C++, and Statistics tracks',
        'roadmap.planned.two': 'Operating Systems, Computer Networks, and Software Engineering tracks',
        'roadmap.planned.three': 'Programming Languages, Computer Architecture, and Cybersecurity tracks',
        'roadmap.planned.four': 'Deeper algorithms path and additional interview-focused practice sets',
    ...
    es: {
        ...
        'topic.comingSoon.networks.title': 'Redes de Computadoras',
        'topic.comingSoon.networks.subtitle': 'TCP/IP, enrutamiento, confiabilidad de transporte y depuracion practica de red',
        'topic.comingSoon.algorithmsPlus.title': 'Algoritmos Avanzados',
        'topic.comingSoon.algorithmsPlus.subtitle': 'Programacion dinamica, metodos avanzados de grafos, algoritmos de cadenas y estrategia de complejidad',
        'topic.comingSoon.pl.title': 'Lenguajes de Programacion',
        'topic.comingSoon.pl.subtitle': 'Paradigmas, sistemas de tipos, interpretes, compiladores y fundamentos de diseno de lenguajes',
        'topic.comingSoon.se.title': 'Ingenieria de Software',
        'topic.comingSoon.se.subtitle': 'Arquitectura, pruebas, CI/CD, flujos de equipo y practicas de mantenibilidad',
        'topic.comingSoon.arch.title': 'Arquitectura de Computadoras',
        'topic.comingSoon.arch.subtitle': 'Conjuntos de instrucciones, pipelines de CPU, caches y razonamiento de rendimiento',
        'topic.comingSoon.cyber.title': 'Ciberseguridad',
        'topic.comingSoon.cyber.subtitle': 'Codigo seguro, autenticacion, defensa ante ataques web y fundamentos practicos de seguridad',
        'roadmap.kicker': 'Hoja de Ruta Publica',
        'roadmap.heading': 'Disponible Ahora, En Progreso, Proximo',
        'roadmap.subtitle': 'Visualiza lo que ya puedes usar hoy y lo que se esta construyendo de forma intencional.',
        'roadmap.live.title': 'Disponible ahora',
        'roadmap.live.one': 'Rutas de aprendizaje de DSA, Java, Git, Ensamblador y Matematica Discreta',
        'roadmap.live.two': 'Modulos con ejemplos de codigo, quizzes, tarjetas, glosario y playgrounds',
        'roadmap.live.three': 'Rutas de inicio para principiantes y flujo guiado rapido',
        'roadmap.live.four': 'Login de cuenta, controles de perfil y base de sincronizacion de progreso',
        'roadmap.progress.title': 'En progreso',
        'roadmap.progress.one': 'Pulido multiplataforma y mejoras de formato responsive',
        'roadmap.progress.two': 'Expansion de modulos y pase de consistencia de calidad de codigo',
        'roadmap.progress.three': 'Ajuste de insights personalizados y mejoras de persistencia solo para cuentas',
        'roadmap.progress.four': 'Endurecimiento para lanzamiento publico con auth SQL y controles de seguridad',
        'roadmap.planned.title': 'Proximo',
        'roadmap.planned.one': 'Rutas de Teoria de la Computacion, C++ y Estadistica',
        'roadmap.planned.two': 'Rutas de Sistemas Operativos, Redes y Ingenieria de Software',
        'roadmap.planned.three': 'Rutas de Lenguajes de Programacion, Arquitectura de Computadores y Ciberseguridad',
        'roadmap.planned.four': 'Ruta de algoritmos mas profunda y mas sets de practica para entrevistas',
